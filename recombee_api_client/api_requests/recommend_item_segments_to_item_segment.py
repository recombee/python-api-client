...
class RecommendItemSegmentsToItemSegment(Request):
    ...
    * Allows the calculation of Actions and Conversions
    ...
    def __init__(self, context_segment_id: str, target_user_id: str, count: int, scenario: str = DEFAULT, cascade_create: bool = DEFAULT, filter: str = DEFAULT, booster: str = DEFAULT, logic: Union[str, dict] = DEFAULT, expert_settings: dict = DEFAULT, return_ab_group: bool = DEFAULT):
        super().__init__(path="/recomms/item-segments/item-segments/", method='post', timeout=3000, ensure_https=False)
